    ...
    render () {
        const cates = this.state.categories.map(( item ) => {
            return (
                ...
                <a key ={ item._id }><Link to ={ '/product/category/' + item._id }>{item.name} </Link ></a>
            );
        }) ;
        return (
            < div className ="border-bottom">
                    ...
                    <div id='heading2'>                
                        <img src ="https://i.pinimg.com/originals/23/19/15/2319154c02c001f8a583703689de9048.gif" width='119px' height='119px' alt ="" />
                    </div>
                <nav>
